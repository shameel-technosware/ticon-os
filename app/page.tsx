                            ...
                            <div className="flex-center justify-content-between">
                                ...
                                <div className="flex-center header-right">
                                    ...
                                    <div className="header-right_actions flex-center">
                                        <div className="header-right_button header-button me-3">
                                            <a href="/login" className="btn-style-one" style={{ background: 'transparent', border: '2px solid #4fcbf1', padding: '18px 35px' }}>
                                                <span style={{ color: '#4fcbf1' }}>Login</span></a>
                                        </div>
